    ...
    <div className="container max-w-6xl mx-auto py-12 px-4 space-y-16">
      ...
      <section>
        <Card>
          ...
          <CardContent className="text-md text-muted-foreground">
            <p>
              Codeverta lahir dari sebuah keyakinan: setiap bisnis, besar maupun
              kecil, berhak mendapatkan partner pengembangan teknologi yang bisa
              dipercaya. Terlalu sering kami melihat proyek digital yang gagal
              karena komunikasi yang buruk, biaya tersembunyi, atau hasil yang
        ...
        <div className="grid md:grid-cols-3 gap-6 text-base">
          ...
          <Card>
            ...
            <CardContent>
              ...
              untuk memberikan produk yang berfungsi optimal dan tepat sasaran.
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="space-y-6 ">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">
            Solusi digital yang kami sediakan untuk mendorong pertumbuhan bisnis
            Anda.
          </p>
        </div>
        <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6 ">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                internal lainnya yang dirancang khusus sesuai alur kerja bisnis
                Anda.
              </CardDescription>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Platform jual beli online yang aman, terintegrasi dengan payment
                gateway, dan mudah dikelola.
              </CardDescription>
            </CardHeader>
          </Card>
          <Card>
