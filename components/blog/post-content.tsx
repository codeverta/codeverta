...
import NewsSchemaJsonLd from "../NewsSchemaJsonLd";
import BreadcrumbSchemaJsonLd from "../BreadcrumbSchemaJsonLd";
...
export default function PostContent({ postData, slug, articleStats }) {
  ...
  // const [activeSection, setActiveSection] = useState(""); // Dihapus karena tidak digunakan
      ...
      <main className="relative min-h-screen bg-cover bg-center bg-no-repeat transition-colors duration-300 max-w-[1200px] mx-auto my-4">
        <div className="">
          ...
          >
              ...
              <div className="p-6 sm:p-8 md:p-12">
                ...
                <header className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    {/* Contributor count hanya ada di salah satu file, jadi saya tambahkan kondisional */}
            ...
            {/* Content Section (Termasuk TOC dari file kedua) */}
            <div className="px-6 sm:px-8 md:px-12 pb-8">
              {/* Tambahkan TOC hanya jika tidak ditampilkan di floating menu */}
              {!showTableOfContents &&
                postData.headings &&
          ...
          {/* Newsletter Signup (Hanya ada di file kedua, jadi saya sertakan) */}
