...
export default function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Access our extensive library of prompt templates or create custom ones for your organization.",
    ...
    },
    {
      ...
      description:
        "Configure your own MCP servers for enhanced performance and control.",
