...
const WhatsappButton = ({
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 flex flex-col items-end z-50 font-sans">
      {/* Tooltip / Speech Bubble */}
      {isVisible && (
        <div className="relative hidden sm:block mb-4 bg-white text-gray-800 p-4 rounded-xl shadow-2xl border border-gray-100 max-w-[250px] animate-bounce-subtle">
          <button
      ...
      <div className="relative group">
        ...
        <span className="absolute -top-1 -right-1 flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-full bg-red-500 text-[9px] sm:text-[10px] font-bold text-white border-2 border-white ring-1 ring-red-500">
          1
        </span>
      </div>
