  ...
  return (
    <div className="prose prose-blue max-w-none dark:prose-invert">
      ...
      <p>
        ...
        when you visit our website {websiteUrl} and use our services. Please
        read this privacy policy carefully. If you do not agree with the terms
        of this privacy policy, please do not access our website or use our
        services.
      </p>
      ...
      <p>
        ...
        for an account, create or modify your profile, set preferences, sign-up
        for or make purchases through our services. This information may
        include:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          Send administrative messages, updates, security alerts, and support
          messages
        </li>
      ...
      <p>
        Your data is stored on secure servers and we maintain strict access
        controls to protect your information. We use industry-standard
      ...
      <p>
        ...
        period is required or permitted by law. We will retain and use your
      ...
      {includeAnalytics && (
        <>
          ...
          <p>
            ...
            use of our services. These services help us understand how users
            interact with our services, which pages are visited most often, and
            how users navigate through our website. This information is used to
      ...
      {includeGDPR && (
        <>
          ...
          <ul>
            ...
            <li>
              The right to data portability - the right to be provided with a
              copy of your Personal Information in a structured,
      ...
      {includeCCPA && (
        <>
          ...
          <p>
            ...
            (CCPA). This section describes your CCPA rights and explains how to
            exercise those rights.
          </p>
          <p>Under the CCPA, you have the following rights:</p>
          <ul>
            <li>
              The right to know about the personal information we collect about
              you and how it is used and shared
            </li>
            <li>
              The right to delete personal information collected from you (with
              certain exceptions)
            </li>
            <li>
      ...
      <p>
        ...
        at <a href={`mailto:${contactEmail}`}>{contactEmail}</a> or by mail at:
      </p>
