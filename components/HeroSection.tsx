...
export default function HeroSection({ t }) {
  ...
  return (
    <section className="w-full py-6 md:py-24 overflow-hidden relative">
      ...
      <div className="container px-4 md:px-6 relative z-10 pointer-events-none">
        ...
        >
          ...
          <p className="text-base md:text-xl text-gray-600 dark:text-gray-400 mb-7 md:mb-10 max-w-2xl mx-auto leading-relaxed font-medium">
            {t("home.subtitle")}
            <br />
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <WhatsappWrapper className="w-full sm:w-auto">
              <Button
                size="lg"
                className="rounded-full w-full sm:w-auto h-12 md:h-14 px-7 md:px-8 text-sm md:text-base font-bold shadow-lg shadow-emerald-500/20 hover:shadow-xl hover:shadow-emerald-500/30 transition-all hover:-translate-y-0.5 bg-green-500 hover:bg-green-600 dark:bg-white text-white dark:text-gray-900"
              >
          ...
          <div className="max-w-4xl mx-auto flex flex-nowrap md:flex-wrap items-center justify-start md:justify-center gap-2.5 md:gap-6 mt-10 md:mt-16 -mx-4 px-4 pb-2 overflow-x-auto overscroll-x-contain snap-x snap-mandatory md:mx-auto md:px-0 md:pb-0 md:overflow-visible text-xs md:text-sm font-medium text-gray-600 dark:text-gray-400 relative z-30 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {" "}
            {[
              ...
              <div
                key={idx}
                className="flex flex-none snap-start items-center gap-2 whitespace-nowrap bg-white/60 dark:bg-zinc-900/60 backdrop-blur-sm px-3.5 md:px-4 py-2 rounded-full border border-gray-200 dark:border-zinc-800 shadow-sm"
              >
