...
export default function UseCases() {
  const useCases = [
    ...
    },
    {
      ...
      title: "Education",
      description:
        "Transform learning experiences and administrative processes with customizable AI solutions.",
        ...
        >
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
              Our AI platform is designed to meet the unique challenges of
              various sectors.
            </p>
          </div>
        </motion.div>
